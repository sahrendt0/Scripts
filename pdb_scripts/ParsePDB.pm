...
#  Date    : October 3, 2014
#  Changes : error: "defined(@array) is deprecated at /usr/local/share/perl/5.18.2/ParsePDB.pm line 409."
#          : omitted 'defined' at line 409
#######################################################################################################################

use strict;                          # always use this!!!
use Data::Dumper;                    # for easy printout of arrays and hashes
use Error qw(:try);                  # for proper exception handling
...
sub Parse { # parses the PDB and sorts all information into the {Models} hash
	...
	if (not @{$self->{Content}}) { $self->Read (ParsePDB => 0) }
